export default function Room203BMonday() {
  return (
    <>
      <tr className="elsewhere">
        <th><time dateTime="2026-02-19T09:00:00+02:00">9:00</time></th>
        <td>(Hackathon Introduction, Room 203 A)</td>
      </tr>
      <tr className="break">
      ...
      <tr>
        ...
        <td rowSpan={2}>
          <h3>Hands on: Care Plans in Denmark</h3>
          <p>Architecture, content & structure of care plans in Denmark.</p>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td rowSpan={2}>
          <h3>Hands on: Care Plans in Turkey</h3>
          <p>Implementation of care plans and computable clinical guidelines in Turkey.</p>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td rowSpan={2}>
          <h3>Hands on: WHO SMART Guidelines</h3>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td rowSpan={3}>
          <h3>Hands on: Preparing an Implementation Guide</h3>
        </td>
      </tr>
      <tr>
