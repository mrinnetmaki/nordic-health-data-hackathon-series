// This file, and therefore also these imports are only used in dev phase, not in production.
...
const imports = {
  ...
  // Reports the use of import declarations with CommonJS exports in any module except for the main
  // module.
